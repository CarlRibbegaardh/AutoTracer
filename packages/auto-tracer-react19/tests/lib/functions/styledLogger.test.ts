...
import {
  ...
  logStateChange,
  logStyled,
} from "../../../src/lib/functions/styledLogger";

// Mock console utilities
vi.mock("../../../src/lib/functions/consoleUtils.js", () => {
  return {
    safeLog: vi.fn(),
  };
});
...
// Mock theme manager
vi.mock("../../../src/lib/functions/themeManager.js", () => {
  return {
...
import { safeLog } from "../../../src/lib/functions/consoleUtils";
import {
  buildStyle,
  getThemeOptions,
} from "../../../src/lib/functions/themeManager";
