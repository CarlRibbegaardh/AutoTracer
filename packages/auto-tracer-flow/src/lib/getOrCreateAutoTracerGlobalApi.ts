...
export function getOrCreateAutoTracerGlobalApi(): AutoTracerGlobalApi {
  ...
  function createNoopTracerRuntimeControls(): TracerRuntimeControls {
    ...
    function setAutoStopTopLevel(_limit: number | null): void {
      return;
    }

    function getAutoStopTopLevel(): number | null {
      return null;
    }

    function setAutoStopAll(_limit: number | null): void {
      return;
    }

    function getAutoStopAll(): number | null {
      return null;
    }
  ...
  const api: AutoTracerGlobalApi = {
    getOutputMode,
    setOutputMode,
    flowTracer: createNoopTracerRuntimeControls(),
  };
