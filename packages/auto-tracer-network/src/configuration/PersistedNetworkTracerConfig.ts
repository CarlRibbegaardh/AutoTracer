/**
 * Represents the NetworkTracer settings currently supported in persisted configuration.
 */
export interface PersistedNetworkTracerConfig {
  ...
  /** Included-request admission limit. */
  readonly autoStopAfterRequests?: number;
}
