...
import {
  ...
  matchByStructure,
} from "../../src/lib/functions/matchByStructure";
import { FUNCTION_PLACEHOLDER } from "../../src/lib/functions/normalization/normalizeValue";
...
describe("matchByStructure", () => {
  ...
  describe("all-functions pattern", () => {
    it("should update function references in all-functions objects", () => {
      const fn1 = () => {return "old"};
      const fn2 = () => {return "new"};
  ...
  describe("real-world scenarios", () => {
    ...
    it("should match microfrontend callback registry after registration", () => {
      const oldLogin = () => {return console.log("old login")};
      const oldLogout = () => {return console.log("old logout")};
      const newLogin = () => {return console.log("new login")};
      const newLogout = () => {return console.log("new logout")};
