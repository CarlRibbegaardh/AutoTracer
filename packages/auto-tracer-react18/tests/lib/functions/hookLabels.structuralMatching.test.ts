...
describe("hookLabels - structural matching for custom hooks", () => {
  ...
  describe("basic structural matching", () => {
    it("should match custom hook by structure when values change", () => {
      ...
      const setValue1 = (v: string) => {return console.log("set", v)};
      const validate1 = (v: string) => {return v.length > 0};
      ...
      const setValue2 = (v: string) => {return console.log("set", v)}; // Different instance!
      const validate2 = (v: string) => {return v.length > 0}; // Different instance!
      ...
      const resolved = resolveHookLabel(0, formState2, { guid, allAnchors: allFiberAnchors });
    ...
    it("should match custom hook even when function references change", () => {
      ...
      // First render
      const increment1 = () => {return console.log("inc")};
      const decrement1 = () => {return console.log("dec")};
      ...
      const increment2 = () => {return console.log("inc")};
      const decrement2 = () => {return console.log("dec")};
      ...
      const resolved = resolveHookLabel(
        0,
        counterState2,
        { guid, allAnchors: allFiberAnchors }
      );
  ...
  describe("complex custom hooks", () => {
    it("should match form hook with nested structure", () => {
      ...
      const resolved = resolveHookLabel(0, form2, { guid, allAnchors: allFiberAnchors });
    ...
    it("should match async query hook with changing status", () => {
      ...
      const resolved = resolveHookLabel(0, query2, { guid, allAnchors: allFiberAnchors });
  ...
  describe("multiple hooks with ordinal disambiguation", () => {
    ...
    it("should handle three hooks with same structure using ordinal", () => {
      ...
      expect(resolveHookLabel(0, newState1, { guid, allAnchors: allFiberAnchors })).toBe(
        "state1"
      );
      expect(resolveHookLabel(1, newState2, { guid, allAnchors: allFiberAnchors })).toBe(
        "state2"
      );
      expect(resolveHookLabel(2, newState3, { guid, allAnchors: allFiberAnchors })).toBe(
        "state3"
      );
    });
  });
  ...
  describe("mixed primitive and object hooks", () => {
    it("should match object hook by structure even when surrounded by primitives with different values", () => {
      ...
      // Primitives with different values should resolve to .internal (label exists at index but value doesn't match)
      expect(resolveHookLabel(0, 5, { guid, allAnchors: allFiberAnchors })).toBe("count.internal");

      // Object with same structure should match
      expect(resolveHookLabel(1, newForm, { guid, allAnchors: allFiberAnchors })).toBe("form");

      // Primitive with different value should resolve to .internal (label exists at index but value doesn't match)
      expect(resolveHookLabel(2, true, { guid, allAnchors: allFiberAnchors })).toBe("isOpen.internal");
    });
  });
  ...
  describe("edge cases", () => {
    it("should handle empty objects", () => {
      ...
      const resolved = resolveHookLabel(0, {}, { guid, allAnchors: allFiberAnchors });
    ...
    it("should handle objects with only functions", () => {
      ...
      const resolved = resolveHookLabel(0, actions2, { guid, allAnchors: allFiberAnchors });
  ...
  describe("real-world patterns", () => {
    it("should match useTrace hook object", () => {
      ...
      const resolved = resolveHookLabel(0, trace2, { guid, allAnchors: allFiberAnchors });
    ...
    it("should match react-hook-form control object", () => {
      ...
      const resolved = resolveHookLabel(0, control2, { guid, allAnchors: allFiberAnchors });
    ...
    it("should match intl object from useIntl", () => {
      ...
      const resolved = resolveHookLabel(0, intl2, { guid, allAnchors: allFiberAnchors });
