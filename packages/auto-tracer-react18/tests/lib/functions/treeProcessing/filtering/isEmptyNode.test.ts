...
import { isEmptyNode } from "../../../../../src/lib/functions/treeProcessing/filtering/isEmptyNode";
import type { TreeNode } from "../../../../../src/lib/functions/treeProcessing/types/TreeNode";
import type {
  PropChangeWithWarning,
  StateChangeWithWarning,
} from "../../../../../src/lib/functions/treeProcessing/types/TreeNode";

describe("isEmptyNode", () => {
  // Helper to create test nodes
  const createNode = (overrides: Partial<TreeNode>): TreeNode => {return {
    depth: 0,
