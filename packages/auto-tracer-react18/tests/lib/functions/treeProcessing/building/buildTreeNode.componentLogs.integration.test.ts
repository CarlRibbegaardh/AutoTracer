...
import { componentLogRegistry } from "@src/lib/functions/componentLogRegistry";
...
function createFiberWithOnlyTrackingRef(componentName: string, guid: string, alternate?: FiberNode | null) {
