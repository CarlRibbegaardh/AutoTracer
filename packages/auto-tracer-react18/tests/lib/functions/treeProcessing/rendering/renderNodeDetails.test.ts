...
import { renderNodeDetails } from "@src/lib/functions/treeProcessing/rendering/renderNodeDetails";
import { traceOptions } from "@src/lib/types/globalState";
import * as log from "@src/lib/functions/log";
...
describe("renderNodeDetails", () => {
  beforeEach(() => {
    vi.resetAllMocks();
    traceOptions.valueRenderingMode = "serialized"; // Default to copy-paste semantics
  });
  ...
  describe("Text Mode (copy-paste)", () => {
    beforeEach(() => {
      traceOptions.valueRenderingMode = "serialized";
    });
  ...
  describe("Object Mode (devtools-json)", () => {
    beforeEach(() => {
      traceOptions.valueRenderingMode = "as-is";
    });
