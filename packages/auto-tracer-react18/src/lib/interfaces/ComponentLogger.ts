/**
 * Logger interface for useReactTracer components
 */
export interface ComponentLogger {
  /**
   * Log a message that will be displayed when the component is rendered by reactTracer
  ...
  /**
   * Log a warning message that will be displayed when the component is rendered by reactTracer
  ...
  /**
   * Log an error message that will be displayed when the component is rendered by reactTracer
