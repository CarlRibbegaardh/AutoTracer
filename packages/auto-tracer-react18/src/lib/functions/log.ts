import { getTraceOptions, isDarkMode } from "../types/globalState.js";
import {
  safeError,
  safeGroup,
  safeGroupEnd,
...
export function logDefinitive(
  ...
  logDefinitiveStyled(prefix, message, styledLoggerOptions, ...args);
}
...
export function groupDefinitive(
  ...
  groupDefinitiveStyled(prefix, message, styledLoggerOptions, ...args);
}
...
export function logReconciled(
  ...
  logReconciledStyled(prefix, message, styledLoggerOptions, ...args);
}
...
export function groupReconciled(
  ...
  groupReconciledStyled(prefix, message, styledLoggerOptions, ...args);
}
...
export function logSkipped(
  ...
  logSkippedStyled(prefix, message, styledLoggerOptions, ...args);
}
...
export function groupSkipped(
  ...
  groupSkippedStyled(prefix, message, styledLoggerOptions, ...args);
}
...
export function logStyled(
  ...
  logStyledStyled(prefix, message, isDefinitive, styledLoggerOptions, ...args);
}
...
export function groupStyled(
  ...
  groupStyledStyled(prefix, message, isDefinitive, styledLoggerOptions, ...args);
}
