...
describe("labelState - all variables in destructuring", () => {
  it("should inject all array destructured variables with name-value pairs", () => {
    ...
    // Should inject: __reactTracer.labelState(0, "title", title, "setTitle", setTitle)
    // Hook index first, then alternating name-value pairs
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]title['"]\s*,\s*title\s*,\s*['"]setTitle['"]\s*,\s*setTitle\s*\)/
    );
  });
  ...
  it("should inject all object destructured variables with name-value pairs", () => {
    ...
    // Should inject: __reactTracer.labelState(0, "a", a, "b", b, "c", c)
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]a['"]\s*,\s*a\s*,\s*['"]b['"]\s*,\s*b\s*,\s*['"]c['"]\s*,\s*c\s*\)/
    );
  });
  ...
  it("should handle array destructuring with rest elements", () => {
    ...
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]first['"]\s*,\s*first\s*,\s*['"]second['"]\s*,\s*second\s*,\s*['"]rest['"]\s*,\s*rest\s*\)/
    );
  });
  ...
  it("should handle object destructuring with rest", () => {
    ...
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]a['"]\s*,\s*a\s*,\s*['"]b['"]\s*,\s*b\s*,\s*['"]rest['"]\s*,\s*rest\s*\)/
    );
  });
  ...
  it("should handle single variable (non-destructured)", () => {
    ...
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]value['"]\s*,\s*value\s*\)/
    );
  });
  ...
  it("should handle array destructuring with null/undefined elements", () => {
    ...
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]second['"]\s*,\s*second\s*,\s*['"]third['"]\s*,\s*third\s*\)/
    );
  ...
  it("should handle renamed object destructuring", () => {
    ...
    expect(result.code).toMatch(
      /__reactTracer\.labelState\(\s*0\s*,\s*['"]renamed['"]\s*,\s*renamed\s*,\s*['"]other['"]\s*,\s*other\s*\)/
    );
  });
});
