 ...
 *
 * Side effects: reads `dist/esm/index.js` and `dist/cjs/index.cjs`; fails if either is absent.
 */
const assertBundledJsDoesNotImportFilterUtils = (): void => {
  const jsPaths: ReadonlyArray<string> = ["dist/esm/index.js", "dist/cjs/index.cjs"];
