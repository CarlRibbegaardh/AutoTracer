...
**Package:** `@autotracer/react19` &nbsp;·&nbsp; **Layer:** Runtime &nbsp;·&nbsp; **Type:** `object` &nbsp;·&nbsp; **Default:** built-in theme

---

`colors` is a runtime configuration option for `reactTracer()` - the initializer of the `@autotracer/react19` React component render tracing library. It customizes the theme and styling used for different render-output categories.
...
If you use `@autotracer/plugin-vite-react19`, theme files can also populate this theme automatically at build time.
