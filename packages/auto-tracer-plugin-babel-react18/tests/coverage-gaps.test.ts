/**
 * Tests targeting specific uncovered branches in the Babel React18 plugin.
 ...
 * inject-react18 finds nothing to trace → no import added → after re-parse,
...
describe("@autotracer/plugin-babel-react18 coverage gaps", () => {
  ...
  describe("outputMode injection via insertAfterDirectivePrologue", () => {
    it("should inject outputMode after 'use client' and non-directive expression", () => {
      ...
      // inject-react18 finds nothing to trace so adds no import — after re-parse,
