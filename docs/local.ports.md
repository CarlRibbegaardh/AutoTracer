...
### apps/perf-test-mui
- Dev (Vite): 5200 (strict)
- Preview (Vite): 5200 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5200

### apps/todo-example-suite-vite5
- Dev (Vite): 5201 (strict)
- Preview (Vite): 5201 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5201

### apps/todo-example-suite-vite6
- Dev (Vite): 5202 (strict)
- Preview (Vite): 5202 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5202

### apps/todo-example-suite-vite7
- Dev (Vite): 5203 (strict)
- Preview (Vite): 5203 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5203

### apps/todo-example-suite-vite8
- Dev (Vite): 5204 (strict)
- Preview (Vite): 5204 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5204

### apps/todo-example-suite-vite7-tsgo
- Dev (Vite): 5205 (strict)
- Preview (Vite): 5205 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5205

### apps/todo-example-suite-vite8-tsgo
- Dev (Vite): 5206 (strict)
- Preview (Vite): 5206 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5206

### apps/todo-example-vite8-react19-ts6-injected
- Dev (Vite): 5207 (strict)
- Preview (Vite): 5207 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5207

### apps/todo-example-vite8-react19-ts7-injected
- Dev (Vite): 5208 (strict)
- Preview (Vite): 5208 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5208

### apps/todo-example-vite8-react19-compiler-injected
- Dev (Vite): 5209 (strict)
- Preview (Vite): 5209 (strict)
- Playwright:
  - `playwright.config.ts`: baseURL/url http://localhost:5209
