...
- **Load ReactTracer once** - Initialize shared tracing instance
...
1. **Loads ReactTracer UMD** from Island 1's dev server:
   ```html
   <script src="http://localhost:5201/auto-tracer-react18.umd.js"></script>
   ```

2. **Initializes ReactTracer globally**:
   ```html
   <script>
       async function initializeTracing() {
          ...
          await new Promise((resolve, reject) => {
             ...
             script.src = "http://localhost:5201/auto-tracer-react18.umd.js";
...
- ReactTracer UMD loaded from Island 1 dev server
