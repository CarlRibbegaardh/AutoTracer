  ...
  overrides: [
    {
      ...
      plugins: [
        [
          ...
          {
            mode: 'opt-out',
            include: { paths: ['src/**/*.tsx', 'src/**/*.jsx', 'pages/**/*.tsx', 'pages/**/*.jsx', 'components/**/*.tsx', 'components/**/*.jsx'] },
            exclude: { paths: ['**/*.test.*', '**/*.spec.*', '**/node_modules/**', '**/.next/**', '**/build/**', '**/dist/**', '**/emotion-is-prop-valid/**', 'unknown.tsx'] },
