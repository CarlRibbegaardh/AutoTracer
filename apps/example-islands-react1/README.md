...
- **Entry**: `src/mount.tsx`
- **Component Prefix**: `Island1` — all traced component names are prefixed as `Island1:ComponentName` so they are identifiable in the DevTools output when multiple islands are on the same page
