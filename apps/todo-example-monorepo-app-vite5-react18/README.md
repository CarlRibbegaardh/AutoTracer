...
This example app demonstrates using components from both **built** and **source** workspace libraries in a pnpm monorepo with ReactTracer support.
...
- Automatic tracing injection via `@autotracer/plugin-vite-react18`
- Hook labeling with `useReactTracer`
...
- ✅ Bundle size optimization: @autotracer/react18 externalized (38 KB saved)
